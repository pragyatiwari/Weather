...
public class WeatherActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new WeatherPresenter(new WeatherDataProvider(this), weatherFragment, this);
    }
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        if (ActivityCompat.checkSelfPermission(this,
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this,
                ...
                mLocationProviderCallback.onLocationError(LocationContract.ERROR_LOCATION_PERMISSION);
            } else {
    ...
    public void onConnectionFailed(@NonNull ConnectionResult connectionResult) {
        mLocationProviderCallback.onLocationError(LocationContract.ERROR_PLAYSERVICE_CONNECTION_FAILED);
    }

    @Override
    public void onConnectionSuspended(int i) {
        mLocationProviderCallback.onLocationError(LocationContract.ERROR_PLAYSERVICE_CONNECTION_SUSPENDED);
    }
        ...
        switch (status.getStatusCode()) {
            ...
            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:// settings need to be changed
                try {
                    ...
                    mLocationProviderCallback.onLocationError(LocationContract.ERROR_ENABLE_LOCATION);
                    mGoogleApiClient.disconnect();
    ...
    public void onLocationChanged(Location location) {
        ...
        if (location != null) {
            ...
            mGoogleApiClient.disconnect();
            mLocationProviderCallback.onLocationError(LocationContract.ERROR_GETTING_LOCATION);
        }
    }
}
